        ...
        <div class="uk-padding">
            <section>
                <div itemprop="articleBody">
                    <div class="uk-text-justify uk-text-secondary uk-text-small font f500"><?php echo $this->item->text; ?></div>
                </div>
            </section>
            <section>
                <div>
                    <?php $sections = explode('<br>', $fieldsValue['sections']); ?>
                    <div>
                        <div class="uk-position-relative">
                            <div class="uk-child-width-1-1 uk-grid-divider" data-uk-grid>
                                <?php for ( $i=0; $i < count($sections)-1; $i++ ) { ?>
                                    <?php $section = explode(",", $sections[$i]); ?>
                                    <div>
                                        <div data-uk-grid>
                                            <?php if(($i % 2) == 0) { ?>
                                                <div class="uk-width-1-1 uk-width-1-3@m">
                                                    <div class="uk-height-1-1 uk-flex uk-flex-center uk-flex-middle">
                                                        <img src="<?php echo $section[0]; ?>" alt="" width="" height="">
                                                    </div>
                                                </div>
