    ...
    <nav class="uk-height-1-1 uk-flex uk-flex uk-flex-middle">
        <ul class="uk-padding-remove uk-margin-remove uk-flex uk-flex-center nav menu<?php echo $class_sfx; ?> mod-list"<?php echo $id; ?>>
            <?php foreach ($list as $i => &$item)
            {
                ...
                if ($item->deeper)
                {
                    echo '<div data-uk-drop="offset:22;delay-hide:200;animation:uk-animation-slide-bottom-small;duration:200;pos:bottom-right;" class="headerDrop"><div class="uk-card uk-card-body uk-card-default uk-padding-remove uk-box-shadow-small"><ul class="uk-padding-remove uk-margin-remove nav-child unstyled small">';
                }
