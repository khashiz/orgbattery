            ...
            <div class="uk-child-width-1-1 uk-grid-small" data-uk-grid>
                    ...
                    <div class="hikashop_vote_stars uk-background-muted uk-border-rounded uk-padding-small uk-text-zero">
                        <div data-uk-grid>
                            <div class="uk-width-expand uk-text-small">
                                <span class="uk-text-muted font f500"><?php echo JText::_('YOUR_VOTE'); ?></span>
                            </div>
                ...
                <?php if(hikashop_loadUser() == null) { ?>
                    ...
                    <div class="uk-width-1-1 uk-width-1-2@m hikashop_comment_form_name">
                        <label class="uk-form-label formControlLabel"><?php echo JText::_('HIKA_USERNAME'); ?>:</label>
                    ...
                    <?php if ($row->email_comment == 1) { ?>
                        <div class="uk-width-1-1 uk-width-1-2@m hikashop_comment_form_mail">
                            <label class="uk-form-label formControlLabel"><?php echo JText::_('HIKA_EMAIL'); ?>:</label>
                    ...
                    <?php } else { ?>
                        <input type='hidden' name="email_comment" id='email_comment' class='uk-hidden' value='0'/>
                    <?php } ?>
                ...
                <?php } ?>
                <div>
                    <label class="uk-form-label formControlLabel"><?php echo JText::_('HIKA_YOUR_COMMENT'); ?>:</label>
