...
?>
	<<?php echo $titleType; ?> class="uk-hidden">
	<?php echo $name; ?>
	</<?php echo $titleType; ?>>
...
if ($this->element->category_id != 66)
    $pageparams->set('page_heading', $this->element->category_name);
...
if($filter_type !== 3) {
	...
	if(!empty($html)){
		...
		if(!empty($htmlFilter) && $ctrl == 'category')
			echo $htmlFilter;
?>
	<div class="uk-width-1-1 uk-width-expand@m hikashop_products_listing">
<?php
