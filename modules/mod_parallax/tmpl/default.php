...
<div class="uk-container">
    <div class="uk-position-relative uk-border-rounded uk-box-shadow-medium uk-overflow-hidden uk-position-relative" style="<?php echo $style; ?>" <?php if ($params->get('parallax') == 1) {echo 'data-uk-parallax="bgy: -300"';} ?>>
