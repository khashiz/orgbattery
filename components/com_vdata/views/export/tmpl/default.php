...
Joomla.submitbutton = function(task) {
	if (task == 'cancel') {
		...
		if(form.server.value == 'write' && form.path.value == ''){
...
<div class="hxd_title">
	<span class="hx_title">
	<?php echo JText::_('VDATA_EXPORT'); ?> <span class="icon-info" id="icon_desc_toggle"></span>
		<div class="sub_desc" id="desc_toggle" style="display:none;"><a class="close" href="javascript:void(0);">×</a><?php echo JText::_('VDATA_EXPORT_DESC_TT'); ?></div>
	</span>
<button class="btn btn-small cancel" onclick="Joomla.submitbutton('cancel');"><span class="icon-cancel"></span><?php echo JText::_('CANCEL');?></button>
	<button class="btn btn-small btn-success" onclick="Joomla.submitbutton('exportready');"><span class="icon-ok"></span><?php echo JText::_('CONTINUE');?></button>
</div>
</div>
...
<div class="col100">
	<fieldset class="adminform">
		<table class="adminform table table-striped">
			...
			<tr>
			  <td>
				<label class="hasTip required" title="<?php echo JText::_('PROFILE_DESC');?>"><?php echo JText::_('PROFILE'); ?></label></td>
		  ...
		  <tr class="rd_block"<?php  if($this->item->source<>"remote")  echo ' style="display:none;"'; ?>>
			<td><label class="hasTip required" title="<?php echo JText::_('TABLE_PREFIX');?>"><?php echo JText::_('TABLE_PREFIX'); ?></label></td>
