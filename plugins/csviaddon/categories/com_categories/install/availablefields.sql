...
('associations', 'associations', 'category', 'com_categories', 'import'),
('image_alt', 'image_alt', 'category', 'com_categories', 'import'),
...
('image_alt', 'image_alt', 'category', 'com_categories', 'export'),
('associations', 'associations', 'category', 'com_categories', 'export');
