...
<div class="col100">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'RSS2_DETAILS' ); ?></legend>
        <table class="adminform table table-striped adminformlist">
		<tr>
			<td colspan="2"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_TAG_DESC');?>"><?php echo JText::_('RSS2_ITEM_TAG');?></label></td>
		</tr>
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_TITLE_DESC');?>"><?php echo JText::_('RSS2_ITEM_TITLE');?></label></td>
			<td>
		...
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_LINK_DESC');?>"><?php echo JText::_('RSS2_ITEM_LINK');?></label></td>
			<td>
		...
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_DESCRIPTION_DESC');?>"><?php echo JText::_('RSS2_ITEM_DESCRIPTION');?></label></td>
			<td>
		...
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_AUTHOR_DESC');?>"><?php echo JText::_('RSS2_ITEM_AUTHOR');?></label></td>
			<td>
				<select name="field[author]">
					<option value=""><?php echo JText::_('SELECT_COLUMNS');?></option>
					<?php foreach($options as $option){?>
						<option value="<?php echo $option;?>" <?php if( !empty($schedule_columns) && property_exists($schedule_columns->fields, 'author') && ($schedule_columns->fields->author==$option) ) echo 'selected="selected"';?>><?php echo $option;?></option>
					<?php }?>
				</select>
			</td>
		</tr>
		<?php /*?><tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_CATEGORY_DESC');?>"><?php echo JText::_('RSS2_ITEM_CATEGORY');?></label></td>
			<td>
				<select name="">
					<option value=""><?php echo JText::_('SELECT_COLUMNS');?></option>
					<?php foreach($options as $option){?>
						<option value="<?php echo $option;?>" <?php ?>><?php echo $option;?></option>
					<?php }?>
				</select>
			</td>
		</tr>
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_COMMENTS_DESC');?>"><?php echo JText::_('RSS2_ITEM_COMMENTS');?></label></td>
			<td>
				
			</td>
		</tr>
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_ENCLOSURE_DESC');?>"><?php echo JText::_('RSS2_ITEM_ENCLOSURE');?></label></td>
			<td>
				
			</td>
		</tr>
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_GUID_DESC');?>"><?php echo JText::_('RSS2_ITEM_GUID');?></label></td>
			<td>
				
			</td>
		</tr><?php */?>
		<tr>
			<td width="200"><label class="hasTip" title="<?php echo JText::_('RSS2_ITEM_PUBDATE_DESC');?>"><?php echo JText::_('RSS2_ITEM_PUBDATE');?></label></td>
			<td>
				<select name="field[pubdate]">
					<option value=""><?php echo JText::_('SELECT_COLUMNS');?></option>
					<?php foreach($options as $option){?>
						<option value="<?php echo $option;?>" <?php if( !empty($schedule_columns) && property_exists($schedule_columns->fields, 'pubdate') && ($schedule_columns->fields->pubdate==$option) ) echo 'selected="selected"';?>><?php echo $option;?></option>
					<?php }?>
				</select>
			</td>
		</tr>
