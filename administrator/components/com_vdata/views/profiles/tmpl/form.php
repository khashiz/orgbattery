...
<tr id="src_enc" <?php if($this->item->iotype){echo 'style="display:none"';} ?>>
	<td><label class="required hasTip" title="<?php echo JText::_('SOURCE_CHARACTER_ENCODING_DESC');?>"><?php echo JText::_('SOURCE_CHARACTER_ENCODING'); ?></label></td>
	<td>
        <select name="source_enc" id="source_enc" class="inputbox required">
            <option value="pass" <?php if(empty($this->item->source_enc) || $this->item->source_enc=='pass') echo 'selected="selected"';?>><?php echo JText::_('Select'); ?></option>
            <option value="UTF-8" <?php if($this->item->source_enc=='UTF-8') echo 'selected="selected"';?>><?php echo JText::_('UTF-8'); ?></option>
			<option value="ISO-8859-1" <?php if($this->item->source_enc=='ISO-8859-1') echo 'selected="selected"';?>><?php echo JText::_('ISO-8859-1'); ?></option>
			<option value="ASCII" <?php if($this->item->source_enc=='ASCII') echo 'selected="selected"';?>><?php echo JText::_('ASCII'); ?></option>
			<option value="EUC-JP" <?php if($this->item->source_enc=='EUC-JP') echo 'selected="selected"';?>><?php echo JText::_('EUC-JP'); ?></option>
        </select>
    </td>
</tr>
<tr>
