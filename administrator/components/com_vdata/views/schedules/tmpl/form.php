...
<?php }?>
<tr>
	<td width="200"><label class="hasTip required" title="<?php echo JText::_('CRON_RESTRICTION_DESC');?>"><?php echo JText::_('CRON_RESTRICTION');?></label></td>
	<td>
		<select name="cron_restriction">
			<option value="0" <?php if(!$this->item->cron_restriction) echo 'selected="selected"';?>><?php echo JText::_('ACCESS_TO_SERVER_ONLY');?></option>
			<option value="1" <?php if($this->item->cron_restriction==1) echo 'selected="selected"';?>><?php echo JText::_('ACCESS_TO_PUBLIC');?></option>
		</select>
	</td>
</tr>
