					...
					<tr>
						...
						<td>
							<div class="name break-word">
								...
								?>
								<span class="small"><?php echo JText::sprintf('COM_CSV_TEMPLATE_LIST_ALIAS', $item->template_alias); ?></span>
							</div>
						</td>
						<td class="break-word">
						...
						<td>
							<?php
								$task = $item->action === 'import' ? 'imports.selectsource' : 'export.start';
								echo JHtml::_(
									'link',
									JRoute::_('index.php?option=com_csvi&task=' . $task . '&csvi_template_id=' . (int) $item->csvi_template_id),
									JText::_('COM_CSVI_RUN'),
...
<script>
	Joomla.submitbutton = function (task) {
		...
		if (task === 'templates.backupTemplates') {
